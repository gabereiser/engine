...
namespace Reactor.Platform.glTF
{
    public static class Interface
    {
        ...
        private static Stream TryLoadBase64BinaryBufferUnchecked(Schema.Buffer buffer, string prefix)
        {
        ...
        private static Stream LoadBinaryBufferUnchecked(Schema.Buffer buffer, Func<string, Stream> externalReferenceSolver)
        {
